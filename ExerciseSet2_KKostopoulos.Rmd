...
Let's now see how the 20 first principal components look like. Let's also not show any numbers less than 0.3 in absolute value, to avoid cluttering. Note again that you can sort the table according to any column by clicking on the header of that column. 
<br>

```{r echo=TRUE, comment=NA, warning=FALSE, error=FALSE,message=FALSE,results='asis',tidy=TRUE}
Rotated_Results<-principal(futures_data, nfactors=20, rotate="varimax",score=TRUE)
...
3. Can we interpret the first 5 components? How would you call these factors?
...
**Your Answers here:**
<br>
1. You need at least 6 components to explain 50% of the variances
<br>
2. The highest weight on component 1 is 0.93
<br>
3. Component 1 are bonds, Component 2 are FX, Component 3 and 4 are market indices and Component 5 are futures. Components 1-5 are financial indicators. 
<br>
4.
<br>
Pre-Crisis Data
...
<br>
5. Component 1 explains more of the variance during crisis years than non-crisis years.
<br>
